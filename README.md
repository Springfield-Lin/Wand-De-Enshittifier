...
**I've built and uploaded my own custom fork in the releases page, only get the app from there AND NOWHERE ELSE and make absolutely sure to verify the file checksum every time you download. - Springfield**
